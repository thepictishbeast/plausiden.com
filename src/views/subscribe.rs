...
pub fn render() -> Markup {
    ...
    let hero_band = html! {
        section class="pd-hero relative pt-32 pb-16 md:pt-44 md:pb-24 bg-slate-50 overflow-hidden" { // loom-allow: custom hero shell — pt-32/44 cadence below Loom Section padding scale
            div class="container relative mx-auto px-4 md:px-6 z-10 max-w-3xl pd-reveal" { // loom-allow: hero container max-w-3xl with z-10 stacking
