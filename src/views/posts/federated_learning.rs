...
pub fn render() -> Markup {
    html! {
        ...
        (ArticleHeading { text: "The premise: privacy and intelligence aren't opposed" }.render())
        ...
        (ArticleHeading { text: "What \"public-by-construction\" means in practice" }.render())
        ...
        ul {
            li { "What domain it came from (e.g., " code { "@mailchimp.com" } ") — already on the envelope, visible to every relay it touched." }
        ...
        (ArticleHeading { text: "How the collective gets smarter" }.render())
        ...
        (ArticleHeading { text: "What this is not" }.render())
        ...
        (ArticleHeading { text: "Why we think this matters" }.render())
        ...
        (ArticleHeading { text: "The shape of \"compose, don't compromise\"" }.render())
        ...
        (ArticleHeading { text: "Where this lives" }.render())
