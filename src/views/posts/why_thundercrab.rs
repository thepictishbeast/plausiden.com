...
pub fn render() -> Markup {
    html! {
        ...
        (ArticleHeading { text: "What got lost" }.render())
        ...
        (ArticleHeading { text: "Why nobody has fixed it" }.render())
        ...
        (ArticleHeading { text: "What we're building" }.render())
        ...
        (ArticleHeading { text: "What \"local-first\" means here" }.render())
        ...
        (ArticleHeading { text: "What it isn't" }.render())
        ...
        (ArticleHeading { text: "Why we care enough to build it" }.render())
        ...
        (ArticleHeading { text: "What's shipping when" }.render())
