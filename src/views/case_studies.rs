...
pub fn render() -> Markup {
    ...
    let body = html! {
        section class="pd-hero relative pt-32 pb-16 md:pt-44 md:pb-24 bg-slate-50 overflow-hidden" { // loom-allow: hero band — pt-32/44 + pb-16/24 cadence below Loom Section padding scale
